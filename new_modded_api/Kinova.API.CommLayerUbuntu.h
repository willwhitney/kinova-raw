...
*/
// extern "C" int RS485_Read(RS485_Message* PackagesIn, int QuantityWanted, int &ReceivedQtyIn);

// extern "C" int RS485_Write(RS485_Message* PackagesOut, int QtyToSend, int &QtySent);

// extern "C" int RS485_Activate(void);
